...
/*   Updated: 2023/06/10 19:43:45 by antoda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sx_stack(t_stack *p2s, char stack, int print)
{
	...
	if (stack == 'a' && push.ta != NULL)
	{
		ft_sx(&push.ta);
		if (print)
			printf("s%c\n", stack);
	}
	else if (stack == 'b' && push.tb != NULL)
	{
		ft_sx(&push.tb);
		if (print)
			printf("s%c\n", stack);
...
void	ft_px_src(t_elem **top_src, t_elem **top_dst)
{
